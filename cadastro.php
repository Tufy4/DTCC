    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-6 bg-danger rounded-top">
                <div class="row justify-content-center">
            <div class="col btn btn-danger">Cadastro</div>
            <div class="col btn btn-danger">login</div>
        </div>
    </div>
    </div>
        ...
        <form class="px-4 py-3">
          <div class="form-group">
            <label for="exampleDropdownFormEmail1">Nome Completo</label>
        ...
        <a class="register" href="#">Novo, por aqui? Regitre-se.</a> 
...
<div class="col-1"></div>
<div class="col-2 v">Termos</div>
<div class="col-2"></div>
</div>

<div class="row">
    <div class="col-2"></div>
    <div class="col-2 b">Quem somos </div>
    <div class="col-1"></div>
    <div class="col-2 b">SAC: 40028922</div>
    <div class="col-1"></div>
    <div class="col-2 b">Politica de privacidade</div>
    <div class="col-2"></div>
</div>

    <div class="row">
        <div class="col-2"></div>
        <div class="col-2 b">Perguntas frequentes </div>
        <div class="col-1"></div>
        <div class="col-2 b">Email</div>
        <div class="col-1"></div>
        <div class="col-2 b">Termos e condições</div>
        <div class="col-2"></div>
        ...
        <div class="row">
            ...
            <div class="col-2"></div>
            <div class="col-1"></div>
            <div class="col-2 b">Politica de frete</div>
            <div class="col-2"></div>
            </div>
